...
│
└── visualizer/
    ├── traje_3d.html             ← 3D full suit visualizer
    └── casco_3d.html             ← 3D helmet visualizer
```
...
Conceptual design developed with AI assistance (Claude — Anthropic, 2026).

---

## 🤖 AI System (ROS2)

The AI system is implemented as a ROS2 package located in `src/traje_ironman_ai/`.

### Quick Start

```bash
# Install dependencies
pip install -r src/traje_ironman_ai/requirements.txt

# Build ROS2 package
cd src/traje_ironman_ai
colcon build
...
|------|-----------|----------|
| sensor_fusion | 100 Hz | Kalman filter sensor fusion |
| flight_controller | 100 Hz | 6-DOF PID stabilization |
| motor_manager | 1000 Hz | EDF + RCS control |
| obstacle_detection | 30 Hz | YOLO v8 object detection |
| route_planner | 10 Hz | A* 3D route planning |
| pilot_learning | 1 Hz | LSTM behavior learning |
| energy_manager | 5 Hz | Battery/H₂/solar management |
| emergency | 10 Hz | Safety and emergency protocols |
| hud_manager | 30 Hz | Helmet HUD display |
